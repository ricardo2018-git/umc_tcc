	  ...
	  <h2>Nova Disciplina</h2>
		...
		<form class="form-horizontal" action="../../../control/novaMateria.php" id="form" method="post">
			<div class="form-group">
				...
				<input type="text" class="form-control" id="di" required>
				...
				<textarea class="form-control" rows="5" id="co" required></textarea>
				<label for="img">Imagem:</label>
				<input type="file" class="form-control" name="file"><br>
				<label for="pro">Professor:</label>
				<input class="form-control" id="pro" type="text" value="<?php echo $_SESSION['eMail'] ?>" disabled>
			  <div class="radio">
